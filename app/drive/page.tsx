...
const fleet: FleetCar[] = [
  ...
  { id: 'flying-spur', make: 'Bentley', model: 'Flying Spur W12', category: 'saloon', badge: 'Chauffeur Available', passengers: 4, spec: '6.0L W12, 635bhp touring saloon', chips: ['4 passengers', '4 luggage'], priceFrom: '£1,200', image: 'https://images.unsplash.com/photo-1542362567-b07e54358753?w=900&q=85', cta: 'Reserve' },
  ...
  { id: 'cullinan', make: 'Rolls-Royce', model: 'Cullinan', category: 'suv', badge: 'Chauffeur Available', passengers: 5, spec: '6.75L V12, all-terrain presence', chips: ['5 passengers', '5 luggage'], priceFrom: '£2,200', image: 'https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?w=900&q=85', cta: 'Reserve' },
      ...
      <section className="page-hero page-hero-clear-top">
        ...
        <div className="page-hero-inner">
          <motion.div {...fadeUp()} className="page-hero-copy page-hero-copy-raised">
            <span className="eyebrow page-hero-kicker">Drive</span>
